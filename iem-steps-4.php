...
<div class="container">
    ...
    border: 1px solid rgba(0, 0, 0, 0.1);">
                    ...
                    <p class="samefornt-like-checkbox">Bitte geben Sie hier Ihr
                            mögliches Startdatum an:</p>
        ...
        <div class="col-12 col-md-5 text-center responsive-column-padding-20">
            <div class="">
                <div class="aus-button-container">
                    <a href="iem-steps-5.php" class="button-download <?php echo $class_name; ?>
                    button-select-common">Weiter zur
                        nächsten
                        Frage</a>
                </div>
            </div>
