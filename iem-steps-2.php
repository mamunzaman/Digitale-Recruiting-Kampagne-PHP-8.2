...
/****************
 * this is for specific job type selection for email check for individual job posts.
 */
$find_job_type = array(
        's2' => 'abgeschlossene-ausbildung-als-elektroniker-für-automatisierungstechnik-m-w-d',
        's3' => 'abgeschlossene-ausbildung-als-mechatroniker-m-w-d'
);
$job_type = url_slug($profession_sub_name);
$job_type = array_search($job_type,$find_job_type,true);
$_SESSION['applicant_data']['s-0']['type'] = filter_var($job_type, FILTER_SANITIZE_STRING, FILTER_FLAG_STRIP_HIGH);

$profession_sub_name = '';
foreach ($_SESSION['applicant_data']['s-0'] as $key => $value):
    if( ($key == 'type' ) && ($value == 's2') ){
        //$profession_sub_name = $value;
        $profession_sub_name = 'Elektroniker für Automatisierungstechnik (m/w/d)';
    }elseif( ($key == 'type' ) && ($value == 's3') ){
        $profession_sub_name = 'Mechatroniker (m/w/d)';
    }
endforeach;
    ...
    <div class="justify-content-center row">
        ...
        <div class="col-12 col-md-12 text-center responsive-column-padding-20">
            <div class="top-bottom-space-half" style="padding-top: 0;">
                <h2 class="responsive-margin-t30">Ihre Berufserfahrung als <?php echo $profession_sub_name; ?></h2>
        ...
        <div class="col-12 col-md-5 text-center responsive-column-padding-20">
            <div class="">
                <div class="aus-button-container">
                    <a href="iem-steps-3.php" class="button-download <?php echo $class_name; ?>
